...
let screenCounter = document.querySelector('.screen-count');
let screen = document.querySelector('.screen');
let screenClear = document.querySelector('.screen-clear');

screenCounter.addEventListener('click', function(){
    clicks += 1;
    screen.innerText = clicks;
});
...
audio.src = "../audio/audio-count.mp3";

const audio2 = new Audio ();
audio2.src = "../audio/audio-clearr.mp3";
